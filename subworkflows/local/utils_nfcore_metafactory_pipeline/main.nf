...
\033[0;35m  AlexsLemonade/metafactory ${workflow.manifest.version}\033[0m
-\033[2m----------------------------------------------------\033[0m-
"""
...
* Software dependencies
    https://github.com/AlexsLemonade/metafactory/blob/master/CITATIONS.md
"""
    if (monochrome_logs) {
...
def toolCitationText() {
    ...
    def citation_text = ["Tools used in the workflow included:", "."].join(' ').trim()
